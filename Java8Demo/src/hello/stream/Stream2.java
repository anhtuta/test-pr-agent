...
public class Stream2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Stream<String> bands =
                Files.lines(Paths.get(System.getProperty("user.dir") + "/Stream2_bands.txt"));
        ...
        Stream<String> rows1 =
                Files.lines(Paths.get(System.getProperty("user.dir") + "/Stream2_data.txt"));
        ...
        // 15. Convert List<Integer> to int[]
        List<Integer> heights = Arrays.asList(7, 11, 8, 5, 9);
        int[] h1 = heights.stream().mapToInt(i -> i).toArray();
        printArray(h1);
        int[] h2 = heights.stream().mapToInt(Integer::intValue).toArray();
        printArray(h2);
    }
}
